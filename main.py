...
temperature = st.sidebar.number_input("Temperature (°C)", min_value=0.0, max_value=500.0, value=25.0, step=0.1)
vibration = st.sidebar.number_input("Vibration (mm/s)", min_value=0.0, max_value=50.0, value=1.0, step=0.1)
pressure = st.sidebar.number_input("Pressure (bar)", min_value=0.0, max_value=100.0, value=1.0, step=0.1)
flow_rate = st.sidebar.number_input("Flow Rate (L/min)", min_value=0.0, max_value=500.0, value=10.0, step=0.1)
efficiency = st.sidebar.number_input("Efficiency (%)", min_value=0.0, max_value=100.0, value=90.0, step=0.1)
